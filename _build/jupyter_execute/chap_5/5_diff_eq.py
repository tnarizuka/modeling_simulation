...
# \end{align*}
# 
# 微分方程式には，独立変数が1つのものと複数のものがあり，前者を**常微分方程式**，後者を**偏微分方程式**と呼ぶ．
# また，微分方程式に含まれる最も高次の微分の次数を**微分方程式の階数**と呼ぶ．
# 例えば，上の式は，それぞれ1階微分方程式と2階微分方程式である．
# 
# 微分方程式は１次方程式や連立方程式のように解を求めることができる．
# 微分方程式において解を求めるとは，与えられた微分方程式を満たすような $ x $ と $ t $ の関係式を求めることを指し，これを**微分方程式を解く**という．
# 
# 微分方程式が与えられたときにその解を求める方法は２種類存在する．
# １つ目は式変形を行って解く方法で，これを**解析的に解く**という．
# 一般に，微分方程式を解析的に求めることは困難であり，特に高階の微分方程式や偏微分方程式の場合が難しい．
# そこで，このような場合には２つ目の方法として，数値計算によって解を求める方法がある．
# これを**数値的に解く**という．
# 
# 以下では常微分方程式を例に解ける微分方程式の例をいくつか紹介する．
