...
# 例えば，コイン投げは，表と裏が一定の確率で出るという数理モデルで記述でき，これは最も基本的な確率モデルの一つである．
...
# 乱数を生成するにはいくつかの方法がある．
# 例えば，サイコロを振って出た目を記録するだけでも，0〜6の数値から成る乱数を生成することができる．
...
# #### より精度の高い一様乱数生成アルゴリズム
# 
# Pythonでは，高速で長い周期を持つ一様乱数を生成するために，メルセンヌ・ツイスタと呼ばれるアルゴリズムが採用されている．
