...
# 2. ホームチームまたはアウェイチームどちらかのデータを選び，このデータがポアソン分布に従うと仮定してパラメータの最尤推定値を求めよ．
...
# 2. ホームチームまたはアウェイチームどちらかのデータを選び，このデータが正規分布に従うと仮定してパラメータの最尤推定値を求めよ．
