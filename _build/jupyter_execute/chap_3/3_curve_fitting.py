...
# 3. [south_korea_covid.csv](https://drive.google.com/uc?export=download&id=14l9chvX4PqHMQQl2yTQTPm7J7S5Us6Xz)は新型コロナウイルスの流行初期（2020年）における韓国の感染者数の推移データである．このデータを読み込み，横軸に経過日数，縦軸に感染者数を取った散布図を描け．また，散布図に対し，以下のシグモイド関数によるフィッティングを実行せよ．
#    
#    $$
