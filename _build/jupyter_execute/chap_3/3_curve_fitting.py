...
# 
# **C. ポアソン分布の最尤推定（データ解析）**
# 1. [score_germany.csv](https://drive.google.com/uc?export=download&id=1FVw2xauvJ1tOnYQ8WJTHKsIVO2Gvesso)は，ブンデスリーガの2017-2018シーズンにおける一方のチームの１試合の得点数データである．このデータをダウンロードし，データフレームに読み込め．
# 2. このデータがポアソン分布に従うと仮定して，ポアソン分布の最尤推定値を求めよ．
# 3. このデータからヒストグラムを作成せよ．また，最尤推定値をパラメータとするポアソン分布を重ね描きせよ．
# 
# **D. 正規分布の最尤推定（データ解析）**
# 1. [score_nba.csv](https://drive.google.com/uc?export=download&id=11w-vbKo7TWxDs9A76Gzp57V1mA9_xcYj)は，NBAの2015-16シーズンにおける一方のチームの１試合の得点数データである．このデータをダウンロードし，データフレームに読み込め．
# 2. このデータが正規分布に従うと仮定して，正規分布の最尤推定値を求めよ．
# 3. このデータからヒストグラムを作成せよ．また，最尤推定値をパラメータとする正規分布を重ね描きせよ．
